...
This TA for Ubiquiti was developed for an environment with CloudKey, USG and Pro AP.  This release supports field extractions for the Firewall and DHCP facilities. It requires 3 indexes; ubnt, netdhcp and netfw. The net* indexes are there for CIM compliance
